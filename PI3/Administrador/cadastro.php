...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if ($tipo === 'Secretaria' || $tipo === 'Professor') {
        ...
        $tabela = 'Usuarios';
        $campos = "nome, email, senha, matricula, cpf, rg, data_nascimento, telefone, endereco, tipo";
        $valores = [$nome, $email, $senha, $matricula, $cpf, $rg, $data_nascimento, $telefone, $endereco, $tipo];
        $sql = "INSERT INTO $tabela ($campos) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?)";
    } else if ($tipo === 'Aluno') {
        $tabela = 'Alunos';
        $campos = "nome, email, matricula, cpf, rg, data_nascimento, telefone, endereco";
        $valores = [$nome, $email, $matricula, $cpf, $rg, $data_nascimento, $telefone, $endereco];
        $sql = "INSERT INTO $tabela ($campos) VALUES (?, ?, ?, ?, ?, ?, ?, ?)";
    } else {
